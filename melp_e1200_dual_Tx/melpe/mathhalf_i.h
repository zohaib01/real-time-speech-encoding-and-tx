...
static int16_t melpe_divide_s(int16_t var1, int16_t var2)
{
	int32_t L_div;
	int16_t swOut;
...
static int32_t melpe_L_deposit_l(int16_t var1)
{
	int32_t L_Out;
...
static int32_t melpe_L_deposit_h(int16_t var1)
{
	int32_t L_var2;
...
static int16_t melpe_extract_l(int32_t L_var1)
{
	int16_t var2;
...
static int16_t melpe_extract_h(int32_t L_var1)
{
	int16_t var2;
...
static int16_t melpe_r_ound(int32_t L_var1)
{
	int32_t L_Prod;
	int16_t var2;
...
static int16_t melpe_negate(int16_t var1)
{
	int16_t swOut;
...
static int32_t melpe_L_negate(int32_t L_var1)
{
	int32_t L_Out;
...
static int16_t melpe_add(int16_t var1, int16_t var2)
{
	int32_t L_sum;
	int16_t swOut;
 ...
 *
 *************************************************************************/
static int32_t melpe_L_add(int32_t L_var1, int32_t L_var2)
{
 ...
 *
 *************************************************************************/
static int16_t melpe_sub(int16_t var1, int16_t var2)
{
	int32_t L_diff;
	int16_t swOut;
 ...
 *
 *************************************************************************/
static int32_t melpe_L_sub(int32_t L_var1, int32_t L_var2)
{
	int32_t L_Sum;
...
static int16_t melpe_shr(int16_t var1, int16_t var2)
{
...
static int16_t melpe_shl(int16_t var1, int16_t var2)
{
	int16_t swOut;
	int32_t L_Out;
...
static int32_t melpe_L_shr(int32_t L_var1, int16_t var2)
{
...
static int32_t melpe_L_shl(int32_t L_var1, int16_t var2)
{
...
static int16_t melpe_shift_r(int16_t var1, int16_t var2)
{
	int16_t swOut, swRnd;
...
static int32_t melpe_L_shift_r(int32_t L_var1, int16_t var2)
{
	int32_t L_Out, L_rnd;
...
static int16_t melpe_norm_l(int32_t L_var1)
{
	int16_t swShiftCnt;
...
static int16_t melpe_norm_s(int16_t var1)
{
	short swShiftCnt;
	int32_t L_var1;
...
static int32_t melpe_L_mult(int16_t var1, int16_t var2)
{
	int32_t L_product;
...
static int16_t melpe_mult(int16_t var1, int16_t var2)
{
	int32_t L_product;
	int16_t swOut;
...
static int32_t melpe_L_mac(int32_t L_var3, int16_t var1, int16_t var2)
{
	int32_t L_Out;
...
static int32_t melpe_L_msu(int32_t L_var3, int16_t var1, int16_t var2)
{
	int32_t L_Out;
...
static int16_t melpe_msu_r(int32_t L_var3, int16_t var1, int16_t var2)
{
	int16_t swOut;
...
static int16_t melpe_abs_s(int16_t var1)
{
	int16_t swOut;
 ...
 *
 *************************************************************************/
static int32_t melpe_L_abs(int32_t L_var1)
{
	int32_t L_Out;
...
static int64_t melpe_L40_add(int64_t acc, int32_t L_var1)
{
...
static int64_t melpe_L40_sub(int64_t acc, int32_t L_var1)
{
	if ((acc > MAX_40) || (acc < MIN_40) || (acc != floor(acc))) {
		fprintf(stderr, "BASIC_OP: Error in 40 bits format.\n");
		exit(0);
...
static int64_t melpe_L40_mac(int64_t acc, int16_t var1, int16_t var2)
{
	if ((acc > MAX_40) || (acc < MIN_40) || (acc != floor(acc))) {
		fprintf(stderr, "BASIC_OP: Error in 40 bits format.\n");
		exit(0);
...
static int64_t melpe_L40_msu(int64_t acc, int16_t var1, int16_t var2)
{
	if ((acc > MAX_40) || (acc < MIN_40) || (acc != floor(acc))) {
		fprintf(stderr, "BASIC_OP: Error in 40 bits format.\n");
		exit(0);
...
static int64_t melpe_L40_shr(int64_t acc, int16_t var1)
{
...
static int64_t melpe_L40_negate(int64_t acc)
{
	if ((acc > MAX_40) || (acc < MIN_40) || (acc != floor(acc))) {
		fprintf(stderr, "BASIC_OP: Error in 40 bits format.\n");
		exit(0);
...
static int16_t melpe_norm32(int64_t acc)
{
	int16_t var1;
...
static int32_t melpe_L_sat32(int64_t acc)
{
	int32_t L_var_out;
